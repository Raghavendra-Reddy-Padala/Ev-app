  ...
  factory GroupAggregateModel.fromJson(Map<String, dynamic> json) {
    return GroupAggregateModel(
      aggregateData: json['aggregate_data'] != null
          ? AggregateData.fromJson(json['aggregate_data'])
          : null,
      success: json['success'] ?? false,
    );
  }
...
class AggregateData {
  ...
  factory AggregateData.fromJson(Map<String, dynamic> json) {
    return AggregateData(
      totalCarbon: (json['total_carbon'] as num?)?.toDouble(),
      totalPoints: json['total_points'] is int
          ? json['total_points']
          : int.tryParse(json['total_points'].toString()),
      totalKm: (json['total_km'] as num?)?.toDouble(),
      noOfUsers: json['no_of_users'] is int
          ? json['no_of_users']
          : int.tryParse(json['no_of_users'].toString()),
    );
  }
